              ...
              <div class="card bg-transparent shadow-none border-0 mb-2">
                ...
                >
                  <div class="mb-0 d-flex justify-content-center">
                    <button
                      class="btn btn-link d-flex align-items-center justify-content-between text-decoration-none text-18 btn-block text-left collapsed justify-content-start tutorial-btn"
                      @click="
                        $event.target.classList.toggle('active');
                        startGuide();
                      "
                    ...
                    >
                      <div class="bottum-btn align-items-center">
                        ...
                        <span
                          class="color-secondary text-capitalize font-medium pl-2"
                          >Walkthrough</span
                        >
                      </div>
                    </button>
